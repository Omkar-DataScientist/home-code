...
# MAGIC %run ../Includes/Classroom-Setup-2.03
...
# MAGIC 
# MAGIC Setting up separate databases and storage accounts for different layers<br/>
...
# MAGIC - Configure Auto Loader's schema location for automatic inference
